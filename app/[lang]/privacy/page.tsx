...
export async function generateMetadata({ params: { lang } }: { params: { lang: Locale } }) {
    return {
        title: 'Privacy Guard & Policy | PDFToolskit',
    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-4xl space-y-12">
            ...
            <div className="border-t border-white/5 pt-12">
                <h1 className="text-4xl font-bold mb-8 text-slate-900 dark:text-white tracking-tight">Privacy Policy</h1>
                <p className="text-slate-600 dark:text-slate-400 mb-8">Last updated: February 24, 2026</p>
                ...
                <div className="prose prose-slate dark:prose-invert max-w-none">
                    <section className="mb-8">
                        ...
                        <p>
                            ...
                            <strong> We do not store, copy, or share your files. All file processing happens locally in your browser leveraging the local Apex OS.</strong>
                        </p>
                    </section>
